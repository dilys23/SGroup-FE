  ...
  export default {
      ...
      methods: {
          validate: function () {
              ...
              }else if (!this.password.match(/^[a-zA-Z0-9!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]{6,12}$/)) {
                  this.validation.invalid.password = 'Password should contain 6-12 characters, including letters, numbers, and special characters.'
              }else {
